...
void oovGui::openProject()
    ...
    PathChooser ch;
    if(ch.ChoosePath(Gui::getMainWindow(), "Open OOVAIDE Project Directory",
...
void oovGui::makeCmake()
    ...
    if(cmakeDlg.run(true))
        ...
        if(putInSource)
            ...
            stat += "\nCheck the oovaide directory for CMake files.";
...
int main(int argc, char *argv[])
    ...
    if(builder.addFromFile("oovaideLayout.glade"))
        {
...
extern "C" G_MODULE_EXPORT void on_HelpAboutmenuitem_activate(
    ...
    gtk_show_about_dialog(Gui::getMainWindow(), "program-name", "Oovaide",
...
extern "C" G_MODULE_EXPORT void on_HelpContentsMenuitem_activate(
    GtkWidget * /*widget*/, gpointer /*data*/)
    {
    displayHelpFile("oovaideuserguide.html");
    }

extern "C" G_MODULE_EXPORT void on_BuildArgsHelp_clicked(
    GtkWidget * /*widget*/, gpointer /*data*/)
    {
    displayHelpFile("oovaidebuildhelp.html");
    }
